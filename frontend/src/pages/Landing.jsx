...
const Landing = () => {
  ...
  return (
    <div>
      ...
      <div className="sticky top-0 z-10 mb-8 flex justify-end px-4 py-4">
        <LanguageSwitcher />
      </div>
      ...
      <div className="space-y-20">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className="glass-panel card-enter p-6 space-y-4"
                >
        ...
        <footer className="border-t border-white/10 py-12">
          ...
          <div className="mt-8 border-t border-white/10 pt-8 text-center text-sm text-slate-400">
            <p>
              &copy; 2024 SmartBus Tracker. Developed as part of Capstone
